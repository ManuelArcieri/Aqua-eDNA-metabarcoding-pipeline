...
parser.add_argument("--percent_sway",
                    help = "when comparing greater than 1 blast hit, value is the percent from best hit considered. i.e. if best blast hit is 99.5 ID, a value of 0.5 will consider everything 99 and greater when creating the consensus", type = float,
                    default = 0.5)
...
if args.blast_file is None and args.blast_database is None:
